...
- 修复 f:/fs:/fe: 不能选择 shadingEngine 节点的问题
- 添加 /a 的使用说明
- 修复快捷键无法覆盖的问题
- 修复使用 - + 时连带shape节点一起重命名的问题
- 修复使用 - + 时不能重命名 shadingEngine 的问题
...
- [x] 安装时弹出窗口设置快捷键
- [ ] 增加一个向下的按钮，列出常用功能，比如一键去除"pasted__"，去除空间名，自动添加类型后缀等
