...
if "%MAYA_INCLUDE%"=="" set "MAYA_INCLUDE=C:\Program Files\Autodesk\Maya2023\include"
if "%MAYA_LIB%"=="" set "MAYA_LIB=C:\Program Files\Autodesk\Maya2023\lib"
if "%QT_INCLUDE%"=="" set "QT_INCLUDE=C:\Program Files\Autodesk\Maya2023\include\qt_5.15.2_vc14-include"
